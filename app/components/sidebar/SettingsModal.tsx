        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='space-y-12'>
                <div className='border-b border-gray-900/10 pb-12'>
                    ...
                    leading-7 text-gray-900 '>Profile</h2>
                    ...
                    <div className='mt-10 flex flex-col gap-y-8'>
                        ...
                        <div className='mt-2 flex items-center gap-x-3'>
                            <Image width='90' height='90' className='rounded-md'
                             src={image|| currentUser?.image || '/images/placeholder.jpg'} alt='avatar'/>
                             <CldUploadButton options={{ maxFiles:1}} onUpload={handleUpload} uploadPreset='mo2muu0p'>
